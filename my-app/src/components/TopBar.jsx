  ...
  return (
    <header class={styles["top-bar"]}>
        <div class={styles["left-section"]}>
            ...
            <span class={styles["app-title"]}>Spotify stats - Solid</span>
        </div>

        <div class={styles["right-section"]}>
            <a class={styles["github-button"]} href={githubUrl} target="_blank" title="GitHub">
                GitHub
            </a>
            {profileData() && <div class={styles["profile-wrapper"]}>
                <img
                    src={profileData().images[1].url}
                    alt="Profile"
                    class={styles["profile-img"]}
                    onClick={toggleMenu}
                    title="Account"
                />
                {showMenu() && <div class={styles["dropdown-menu"]}>
